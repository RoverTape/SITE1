          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div variants={container} initial="hidden" animate="show" className="max-w-4xl">
              ...
              <motion.h1 variants={itemUp} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-foreground leading-tight tracking-tight mb-6">
                {t.services.heading}{' '}
                <span className="animated-gradient-text">{t.services.headingGradient}</span>
              </motion.h1>
              <motion.p variants={itemUp} className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed">
                {t.services.subtitle}
              </motion.p>
            </motion.div>
          </div>
        ...
        <section className="pb-24 md:pb-32">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {t.services.list.map((service, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group relative bg-card rounded-2xl border border-border hover:border-primary/40 transition-all duration-500 hover:shadow-2xl hover:shadow-black/40 overflow-hidden"
                  >
                    ...
                    <div className="relative z-10 p-8 md:p-12">
                      ...
                      <div className="flex flex-col lg:flex-row lg:gap-16">
                        <div className="lg:w-2/5 mb-8 lg:mb-0">
                          ...
                          <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-8">{service.description}</p>
            ...
            >
              ...
              <div className="absolute inset-0 z-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse 60% 60% at 50% 50%, rgba(192,192,192,0.05) 0%, transparent 70%)' }} />
              <div className="relative z-10">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-4">{t.services.bottomCtaHeading}</h2>
                <p className="text-base md:text-lg text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">{t.services.bottomCtaText}</p>
                <Link to="/contato">
